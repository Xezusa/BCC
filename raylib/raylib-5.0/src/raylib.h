...
RLAPI void EndWindow(void);                                       // End window and unload OpenGL context (Previously CloseWindow)
...
RLAPI void RevealCursor(void);                                    // Reveals cursor (Previously named ShowCursor)
